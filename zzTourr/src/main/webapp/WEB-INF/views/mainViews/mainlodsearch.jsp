    ...
    <div class="column4">
      ...
      <br/>
       ...
       <br/>
         ...
         <form action="mainlodgelist.trip?page=1" method="get">
          <input type="submit" value="전체호텔목록보기"/>
          </form>
     </div>
     <c:forEach items="${lodgeList }" var="lodge">
      ...
      <c:forEach var='i' begin='${startNo }' end='${endNo }'>
		    ...
		    <a href="mainlodsearch.trip?page=${i }&searchtext=${searchtext }">${i }</a>
			</c:forEach>
	  <p>&nbsp; </p>
 
         <div class="pagination"> <a href="mainlodsearch.trip?pageNo=1&searchtext=${searchtext }"><<</a><a href="mainlodsearch.trip?pageNo=${pNo }&searchtext=${searchtext }"><</a><a href="mainlodsearch.trip?pageNo=${nNo }&searchtext=${searchtext }">></a><a href="mainlodsearch.trip?pageNo=${totalcount }&searchtext=${searchtext }">>></a></div>
    </div>
    <!-- end of column four -->
  </div>
  <div id="footer">
