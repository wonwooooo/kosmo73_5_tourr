...
<%-- <img src='/hWebBoard1/resources/upload/${board.b_fname}' width='400'> --%>
  ...
  <div class="pagination"> 
	  ...
	  <p>&nbsp; </p>
         ...
         <div class="pagination"> <a href="mainlodgelistmo.trip?page=1"><<</a><a href="mainlodgelistmo.trip?page=${pNo }"><</a><a href="mainlodgelistmo.trip?page=${nNo }">></a><a href="mainlodgelistmo.trip?page=${totalcount }">>></a></div>
