  ...
  <div id="main_content">
      ...
      <div class="left_box">
        ...
        <div class="center_left_box">
          <div class="box_title"><span>비밀번호 찾기</span> </div>
            <div class="form_row">
              <label style="float:center;">비밀번호를 메일로 보내드립니다.</label>         
            </div>
          <div class="form">
            <div class="form_row">
              <label class="left">ID입력: </label>
              <input type="text" class="form_input" />
            </div>
          
            <div style="float:right; padding:10px 25px 0 0;">
               <input type="button" value="비밀번호 메일로 받기" />
            </div>
     
             <div class="form_row">
              <a href="mainlogin.trip" style="text-decoration: none; color:#615357;"><label style="float:center;">로그인 화면으로 돌아가기 </label></a>        
            </div>
