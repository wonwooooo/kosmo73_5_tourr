...
<%-- <img src='/hWebBoard1/resources/upload/${board.b_fname}' width='400'> --%>
  ...
  <div class="pagination"> 
      ...
      <c:forEach var='i' begin='${startNo }' end='${endNo }'>
		    ...
		    <a href="mainlodgelistge.trip?page=${i }">${i }</a>
			</c:forEach>
	  <p>&nbsp; </p>
  </div>
         <div class="pagination"> <a href="mainlodgelistge.trip?page=1"><<</a><a href="mainlodgelistge.trip?page=${pNo }"><</a><a href="mainlodgelistge.trip?page=${nNo }">></a><a href="mainlodgelistge.trip?page=${totalcount }">>></a></div>
