  ...
  <div id="main_content">
    ...
    <div class="column3">
      ...
      <div class="details_list">
        <ul>
          <li><span>트윈룸:</span> 사진보기
          	<p>상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회</p>
          	<p>최대인원 : 2명</p>
          	<p>성수기요금 : 165000원</p>
          	<p>비수기요금 : 130000원</p>
          	<p><a href="mainloreservation.trip"><input type="button" value="예약하기"/></a>&nbsp;<input type="button" value="장바구니추가"/></p>
          </li>
            <li><span>트윈룸:</span> 사진보기
          	<p>상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회상세 정보 조회</p>
          		<p>최대인원 : 3명</p>
      ...
      <div class="title2">세부사항:</div>
       <div class="details_list">
        <ul>
          <li><span>주소:</span> 경기도 화성시 능동 1137 푸른마을 두산위브아파트 141동 121호 </li>
          <li><span>연락처:</span> 010-4708-7412</li>
          <li><span>편의시설:</span> 전자레인지</li>
          <li><span>하절기 성수기:</span> 20/07/01 ~ 20/07/31</li>
          <li><span>동절기 성수기:</span> 20/12/01 ~ 20/12/31</li>
        </ul>
      </div>
      </div>
      <!-- end of column three -->
