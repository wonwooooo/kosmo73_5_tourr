...
<title>adminProdDetail.jsp</title>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">{Room or Guide}</a></li>
                                    ...
                                    <div id="productslider-1" class="product-carousel carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item">
                                                <img class="d-block" src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/eco-slider-img-1.png" alt="First slide">
                                            </div>
                                            <div class="carousel-item active carousel-item-left">
                                                <img class="d-block" src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/eco-slider-img-2.png" alt="Second slide">
                                            </div>
                                            <div class="carousel-item carousel-item-next carousel-item-left">
                                                <img class="d-block" src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/eco-slider-img-3.png" alt="Third slide">
                                            </div>
                                        </div>
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-size border-bottom">
                                        ...
                                        <div class="product-qty">
                                            <h4>Quantity</h4>
                                            <div class="quantity">
                                                <input type="number" min="1" max="9" step="1" value="1"><div class="quantity-nav"><div class="quantity-button quantity-up">+</div><div class="quantity-button quantity-down">-</div></div>
                                            </div>
                                        </div>
                                    </div>
