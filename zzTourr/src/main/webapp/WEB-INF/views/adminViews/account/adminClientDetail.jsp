	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
	                                        ...
	                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Client List</a></li>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card influencer-profile-data">
									...
									<div class="row">
										<div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
											<div class="text-center">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xxl">
											</div>
										</div>
								...
								<div class="border-top user-social-box">
									...
									<div class="user-social-media d-xl-inline-block ">
										<span class="mr-2 medium-color"><i class="fab fa-medium"></i></span><span>291</span>
									</div>
									<div class="user-social-media d-xl-inline-block">
										<span class="mr-2 youtube-color"><i class="fab fa-youtube"></i></span><span>1291</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card">
								<div class="campaign-table table-responsive">
									...
									<tr>
										<td>
											<div class="m-r-10">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/dribbble.png" alt="user" width="35">
											</div>
										</td>
										<td>
											Fashion E Commerce
									...
									<tr>
										<td>
											<div class="m-r-10">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/github.png" alt="user" width="35">
											</div>
										</td>
										<td>
											Fitness Products
									...
									<tr>
										<td>
											<div class="m-r-10">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/dropbox.png" alt="user" width="35">
											</div>
										</td>
										<td>
											Gym Trainer Program
									...
									<tr>
										<td>
											<div class="m-r-10">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/bitbucket.png" alt="user" width="30">
											</div>
										</td>
										<td>
											2018 Top Product
									...
									<tr>
										<td>
											<div class="m-r-10">
												<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/mail_chimp.png" alt="user" width="30">
											</div>
										</td>
										<td>
											Top Dashboard Sale 2018
										</td>
										<td>
											<div class="avatar-group">
												<span><a href="#"><i class="fab fa-fw fa-facebook-square facebook-color"></i></a></span>
					...
					<div class="row">
							...
							<div class="card campaign-card text-center">
								<div class="card-body">
									<div class="campaign-img">
										<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/dribbble.png" alt="user" class="user-avatar-xl">
									</div>
									<div class="campaign-info">
										<h3 class="mb-1">Campaigns Name</h3>
										<p class="mb-3">
											Vestibulum porttitor laoreet faucibus.
										</p>
										<p class="mb-1">
											Min, Views:<span class="text-dark font-medium ml-2">2,50,000</span>
										</p>
										<p>
											Payout: <span class="text-dark font-medium ml-2">$22</span>
										</p>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card campaign-card text-center">
								<div class="card-body">
									<div class="campaign-img">
										<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/github.png" alt="user" class=" user-avatar-xl">
									</div>
									<div class="campaign-info">
										<h3 class="mb-1">Campaigns Name</h3>
										<p class="mb-3">
										...
										<p class="mb-1">
											Min, Views:<span class="text-dark font-medium ml-2">1,00,000</span>
										</p>
										<p>
											Payout: <span class="text-dark font-medium ml-2">$28</span>
										</p>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card campaign-card text-center">
								<div class="card-body">
									<div class="campaign-img">
										<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/slack.png" alt="user" class="user-avatar-xl">
									</div>
									<div class="campaign-info">
										<h3 class="mb-1">Campaigns Name</h3>
										<p class="mb-3">
											Maecenas mattis tempor libero pretium.
										</p>
										<p class="mb-1">
											Min, Views:<span class="text-dark font-medium ml-2">3,80,000</span>
										</p>
										<p>
											Payout: <span class="text-dark font-medium ml-2">$36</span>
										</p>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card campaign-card text-center">
								<div class="card-body">
									<div class="campaign-img">
										<img src="${pageContext.request.contextPath}/resources/adminTemplate/assets/images/mail_chimp.png" alt="user" class="user-avatar-xl">
									</div>
									<div class="campaign-info">
										<h3 class="mb-1">Campaigns Name</h3>
										<p class="mb-3">
											Proin vitae lacinia leo
										</p>
										<p class="mb-1">
											Min, Views:<span class="text-dark font-medium ml-2">4,50,000</span>
										</p>
										<p>
											Payout: <span class="text-dark font-medium ml-2">$57</span>
										</p>
										<a href="#"><i class="fab fa-twitter-square fa-sm twitter-color"></i></a><a href="#"><i class="fab fa-snapchat-square fa-sm snapchat-color"></i></a>
