...
<head>
<title>BuildUp Real Estate - Admin</title>
...
<link rel="stylesheet" type="text/css" href="/zzTourr/resources/customercss/style.css" />
<link rel="stylesheet" type="text/css" href="/zzTourr/resources/customercss/admin.css" />
</head>
<body>
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <input type="button" name="confirm" id="confirm" value="선택 삭제">
    ...
    <div class="table_grid">
      <table cellspacing="0" cellpadding="0">
        <tr>
          ...
          <th style="width:20px;"><a href="http://all-free-download.com/free-website-templates/" class="pink">상품ID</a></th>
