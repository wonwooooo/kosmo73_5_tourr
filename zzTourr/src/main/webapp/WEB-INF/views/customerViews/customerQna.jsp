...
<head>
<title>customerQna 1:1문의내역</title>
  ...
  <div id="main_content">
    ...
    <div class="column">
      <div class="title" style="float:left;">
        <div style="float:left;">1:1문의내역</div>
...
<!--     	<span class="right_cont"><a href="#" class="btn pink">1:1문의하기</a></span> -->
    	<input style="float:right;" type="button" value="1:1문의하기"/>
